...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 07, 2015 at 07:30 AM
...
('299bd388886ef7f59d62fb746d3d7008', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0', 1420590557, 'a:2:{s:9:"user_data";s:0:"";s:8:"language";s:2:"id";}'),
('4203849c71c3225808db00db54fccb63', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0', 1420293005, 'a:2:{s:9:"user_data";s:0:"";s:8:"language";s:2:"id";}'),
('424c76716da9121a63f3f5c2e5820410', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0', 1420590557, 'a:2:{s:9:"user_data";s:0:"";s:8:"language";s:2:"id";}'),
('5458e61611f8e6dc90fb64092f817db6', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:34.0) Gecko/20100101 Firefox/34.0', 1420590321, 'a:2:{s:9:"user_data";s:0:"";s:8:"language";s:2:"id";}');
...
(2, 'Hari Prasetyo', '198507262006021003', 'hari', 'f0526773cf03aeabafb3524fdf7ffded', 'operator', 'no_photo.png');
...
--
-- Indexes for table `kantor_kanwil`
--
ALTER TABLE `kantor_kanwil`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `kantor_kppbc`
--
ALTER TABLE `kantor_kppbc`
 ADD PRIMARY KEY (`id`);
...
ALTER TABLE `kegiatan`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `judul_id` (`judul_id`,`judul_en`,`slug`);
...
--
-- AUTO_INCREMENT for table `kantor_kanwil`
--
ALTER TABLE `kantor_kanwil`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT for table `kantor_kppbc`
--
ALTER TABLE `kantor_kppbc`
