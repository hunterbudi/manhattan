<?php
$query = "SELECT * FROM tentang WHERE kode LIKE 'organisasi'";
...
<aside class="right-side">
    ...
    <small>Organisasi Bea dan Cukai</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Tentang Bea dan Cukai</li>
        <li class="active">Organisasi Bea dan Cukai</li>
    </ol>
    </section>
    <!-- Main content -->
    <section class="content">
    <script src="standar_editor/ckeditor.js"></script>
    <form name="organisasi" method="post" action="?module=organisasi">  
    ...
    if (isset($_POST['simpan'])){
        ...
        $query = "UPDATE tentang SET isi_id='$isi_id',isi_en='$isi_en' WHERE kode LIKE 'organisasi'";
        $sql = mysql_query($query);
        
        if ($sql){        
                echo "<script>alert ('Konten berhasil diupdate, terima kasih')</script>";
		echo '<script type="text/javascript">window.location="?module=organisasi"</script>'; 
            }
        }
    ?>
    <br>
