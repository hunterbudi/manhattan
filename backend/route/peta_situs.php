<?php
$query = "SELECT * FROM website WHERE kode LIKE 'peta_situs'";
...
<aside class="right-side">
    ...
    <form name="peta_situs" method="post" action="?module=peta_situs">  
    ...
    if (isset($_POST['simpan'])){
        ...
        $query = "UPDATE website SET isi_id='$isi_id',isi_en='$isi_en' WHERE kode LIKE 'peta_situs'";
        $sql = mysql_query($query);
        
        if ($sql){        
                echo "<script>alert ('Konten berhasil diupdate, terima kasih')</script>";
		echo '<script type="text/javascript">window.location="?module=peta_situs"</script>'; 
            }
        }
    ?>
    <br>
