<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Rekam Kiriman Pos</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">PPLB, Kiriman dan Pos</li>
            <li class="active">Rekam Kiriman Pos</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <script src="ckeditor/ckeditor.js"></script>
        <form name="aeo" method="post" action="?module=kiriman_pos" enctype="multipart/form-data">  
            ...
            if (isset($_POST['simpan'])) {
                ...
                function newID() {
                    $now = date('Y');
                    $query = "SELECT max(urut) as maxID FROM kiriman where jenis='kiriman_pos'";
                    $hasil = mysql_query($query);
                    $data = mysql_fetch_array($hasil);
                    $idMax = $data['maxID'];

                    $querybaru = "SELECT * FROM kiriman where urut='$idMax' and  jenis='kiriman_pos'";
                ...
                $query = "INSERT INTO kiriman (judul_id,judul_en,isi_id,isi_en,jenis,urut)"
                        . " VALUES ('$judul_id','$judul_en','$isi_id','$isi_en','kiriman_pos','$nourutbaru')";
                $sql = mysql_query($query);

                if ($sql) {
                    echo "<script>alert ('Kiriman Pos berhasil disimpan, terima kasih')</script>";
