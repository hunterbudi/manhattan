...
<aside class="right-side">
    ...
    <section class="content">
        ...
        if (isset($_POST['simpan'])) { // jika tombol editsubmit ditekan
            ...
            $edit = mysql_query("UPDATE kantor_kppbc SET
							nama='$nama',
							profil='$profil',
                                                        koordinat='$koordinat',
                                                        nama_kanwil='$nama_kanwil'
					WHERE id='$id' ");
            echo "<script>alert ('Kantor Bea Cukai diperbaharui, terima kasih')</script>";
            echo "<script type='text/javascript'>window.location='?module=kantor'</script>";
        } else {
            $id = $_GET['id']; // menangkap id
            
            $sql = "SELECT * FROM kantor_kppbc WHERE id='$id' "; // memanggil data dengan id yang ditangkap tadi
            $query = mysql_query($sql);
            $data = mysql_fetch_array($query);
            ?>
                <form name="impor" method="post" action="?module=kantor_edit" enctype="multipart/form-data">  
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledBy="home-tab">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td width="2%"></td>
                                        <td width="50%">
                                            <input id="nama_kanwil" type="text" value="<?php echo $data['nama_kanwil']  ?>" name="nama_kanwil" class="form-control" />
                                        </td>
                                        <td width="3%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="2%"></td>
                                        <td width="78%" colspan="2"><textarea id="indonesia" name="profil" cols="80" rows="10"><?php echo $data['profil']  ?></textarea></td>
                                    </tr>
                                    <tr>
                                        <td width="20%">Koordinat</td>
                                        <td width="2%"></td>
                                        <td width="30%" colspan="2"><input type="text" name="koordinat" value="<?php echo $data['koordinat']  ?>" class="form-control"></td>
                                    </tr>
                            ...
                            <table class="table">
                                <tr>
                                    <td width="20%"></td>
                                    <td width="2%"></td>
                                    <td width="78%"><input type="submit" class="btn btn-primary" value="SIMPAN" name="simpan" onClick="return confirm('Perubahan Kantor akan disimpan?');"></td>
                                </tr>        
                            </table>
                        </div>
                    </div>
