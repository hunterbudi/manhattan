...
$sql = mysql_query("SELECT * FROM kegiatan WHERE id='$id'");
...
<aside class="right-side">
    ...
    <form name="kegiatan_edit" method="post" action="?module=kegiatan_edit" enctype="multipart/form-data">  
    ...
    if (isset($_POST['simpan'])){
        ...
        $query = "UPDATE kegiatan SET judul_id='$judul_id', judul_en='$judul_en', isi_id='$isi_id', isi_en='$isi_en', uploader='$uploader', tgl_upload='$tgl_upload', slug='$slug' WHERE id='$id'";
        
        $sql = mysql_query($query);
        if($sql){
            echo "<script>alert ('Kegiatan berhasil diedit, terima kasih')</script>";
