<?php
$query = "SELECT * FROM website WHERE kode LIKE 'privasi'";
...
<aside class="right-side">
    ...
    <form name="privasi" method="post" action="?module=privasi">  
    ...
    if (isset($_POST['simpan'])){
        ...
        $query = "UPDATE website SET isi_id='$isi_id',isi_en='$isi_en' WHERE kode LIKE 'privasi'";
        $sql = mysql_query($query);
        
        if ($sql){        
                echo "<script>alert ('Konten berhasil diupdate, terima kasih')</script>";
		echo '<script type="text/javascript">window.location="?module=privasi"</script>'; 
            }
        }
    ?>
    <br>
