    ...
    <section class="content">
        ...
        <div class="col-md-12 col-sm-12">
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post"  name="kurs" action="?module=kurs">
                    <br>
                    <br>
                    <div class="box-body">
                        <div class="form-group">
                             <label class="col-lg-4 control-label">Masukkan Nomor KEP</label>
                                <div class="input-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="no_kep"  required="required"/>
                                </div><!-- /.input group -->
                        </div><!-- /.form group -->
                        <div class="form-group">
                             <label class="col-lg-4 control-label">Masukkan Tanggal KEP</label>
                                <div class="input-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="tgl_kep" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask  required="required"/>
                                </div><!-- /.input group -->
                        </div><!-- /.form group -->                             
                        <div class="form-group">
                            <label class="col-lg-4 control-label">Masukkan Periode KEP</label>
                                <div class="input-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control pull-right" name="periode" id="reservation"  required="required"/>
                                </div> 
                        </div>                    
                    </div>                   
                    <div class="row">        
                            <div class="col-md-1">USD</div>
                            <div class="col-md-2"><input type="text" name="usd" class="form-control" required="required"></div>
                            <div class="col-md-1">AUD</div>
                            <div class="col-md-2"><input type="text" name="aud" class="form-control" required="required"></div>
                            <div class="col-md-1">CAD</div>
                            <div class="col-md-2"><input type="text" name="cad" class="form-control" required="required"></div>
                            <div class="col-md-1">DKK</div>
                            <div class="col-md-2"><input type="text" name="dkk" class="form-control" required="required"></div>
                    </div>
                    <div class="row">        
                            <div class="col-md-1">HKD</div>
                            <div class="col-md-2"><input type="text" name="hkd" class="form-control" required="required"></div>
                            <div class="col-md-1">MYR</div>
                            <div class="col-md-2"><input type="text" name="myr" class="form-control" required="required"></div>
                            <div class="col-md-1">NZD</div>
                            <div class="col-md-2"><input type="text" name="nzd" class="form-control" required="required"></div>
                            <div class="col-md-1">NOK</div>
                            <div class="col-md-2"><input type="text" name="nok" class="form-control" required="required"></div>
                    </div>
                    <div class="row">        
                            <div class="col-md-1">GBP</div>
                            <div class="col-md-2"><input type="text" name="gbp" class="form-control" required="required"></div>
                            <div class="col-md-1">SGD</div>
                            <div class="col-md-2"><input type="text" name="sgd" class="form-control" required="required"></div>
                            <div class="col-md-1">SEK</div>
                            <div class="col-md-2"><input type="text" name="sek" class="form-control" required="required"></div>
                            <div class="col-md-1">CHF</div>
                            <div class="col-md-2"><input type="text" name="chf" class="form-control" required="required"></div>
                    </div>  
                    <div class="row">        
                            <div class="col-md-1">JPY</div>
                            <div class="col-md-2"><input type="text" name="jpy" class="form-control" required="required"></div>
                            <div class="col-md-1">MMK</div>
                            <div class="col-md-2"><input type="text" name="mmk" class="form-control" required="required"></div>
                            <div class="col-md-1">INR</div>
                            <div class="col-md-2"><input type="text" name="inr" class="form-control" required="required"></div>
                            <div class="col-md-1">KWD</div>
                            <div class="col-md-2"><input type="text" name="kwd" class="form-control" required="required"></div>
                    </div>  
                    <div class="row">        
                            <div class="col-md-1">PKR</div>
                            <div class="col-md-2"><input type="text" name="pkr" class="form-control" required="required"></div>
                            <div class="col-md-1">PHP</div>
                            <div class="col-md-2"><input type="text" name="php" class="form-control" required="required"></div>
                            <div class="col-md-1">SAR</div>
                            <div class="col-md-2"><input type="text" name="sar" class="form-control" required="required"></div>
                            <div class="col-md-1">LKR</div>
                            <div class="col-md-2"><input type="text" name="lkr" class="form-control" required="required"></div>
                    </div>  
                    <div class="row">        
                            <div class="col-md-1">THB</div>
                            <div class="col-md-2"><input type="text" name="thb" class="form-control" required="required"></div>
                            <div class="col-md-1">BND</div>
                            <div class="col-md-2"><input type="text" name="bnd" class="form-control" required="required"></div>
                            <div class="col-md-1">EUR</div>
                            <div class="col-md-2"><input type="text" name="eur" class="form-control" required="required"></div>
                            <div class="col-md-1">CNY</div>
                            <div class="col-md-2"><input type="text" name="cny" class="form-control" required="required"></div>
                    </div>  
                    <div class="row">        
                            <div class="col-md-1">KRW</div>
                            <div class="col-md-2"><input type="text" name="krw" class="form-control" required="required"></div>
            ...
            if (isset($_POST['simpan'])) {
                ...
                $cek = mysql_query("SELECT * FROM kurs WHERE no_kep='$no_kep' AND tgl_kep='$tgl_kep'");
                $hasil = mysql_fetch_array($cek);
                
                if ($hasil>='1'){
                    echo "<script>alert ('Data Kurs pernah diinput')</script>";
                ...
                $query = "INSERT INTO kurs (no_kep,tgl_kep,start,stop,usd,aud,cad,dkk,hkd,myr,nzd,nok,gbp,sgd,sek,chf,jpy,mmk,inr,kwd,pkr,php,sar,lkr,thb,bnd,eur,cny,krw,jarak) "
                        . "VALUES ('$no_kep','$tgl_kep','$start','$stop','$usd','$aud','$cad','$dkk','$hkd','$myr','$nzd','$nok','$gbp','$sgd','$sek','$chf','$jpy','$mmk','$inr','$kwd','$pkr','$php','$sar','$lkr','$thb','$bnd','$eur','$cny','$krw','$jarak')";
            
                $sql = mysql_query($query);
                
                if ($sql){
                    echo "<script>alert ('Kurs berhasil diupload, terima kasih')</script>";
                    echo '<script type="text/javascript">window.location="?module=kurs"</script>';  
                }
                }
            }
