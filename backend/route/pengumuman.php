<aside class="right-side">
    ...
    <h1>
    Announcement
    <small>Rekam Pengumuman</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Announcement</li>
        <li class="active">Rekam Pengumuman</li>
    </ol>
    </section>
    <!-- Main content -->
    <section class="content">
    <script src="standar_editor/ckeditor.js"></script>
    <form name="pengumuman" method="post" action="?module=pengumuman" enctype="multipart/form-data">  
    ...
    <div id="myTabContent" class="tab-content">
      ...
      <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledBy="profile-tab">
          <table class="table">
              <tr>
                  <td width="20%">Heading Announcement</td>
                  <td width="2%"></td>
    ...
    if (isset($_POST['simpan'])){
        ...
        $query = "INSERT INTO pengumuman (judul_id,judul_en,isi_id,isi_en,uploader,tgl_upload,slug)"
                . " VALUES ('$judul_id','$judul_en','$isi_id','$isi_en','$uploader','$tgl_upload','$slug')";
        $sql = mysql_query($query);
        
        if ($sql){
            echo "<script>alert ('Pengumuman berhasil diupload, terima kasih')</script>";
    ...
    <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <td class='odd gradeX'>
                ...
                if ($r['publish']==1){
                    if($r['alert']=='0'){
                        echo "<span> <a href=?module=alert&pages=pengumuman&id=$id title='Masukkan Kedalam Alert' class='btn btn-outline btn-danger btn-xs'.";?>
                        onClick="return confirm('Pengumuman akan dimasukkan kedalam halaman utama, Anda yakin?');"
                        <?php echo "."."> <i class='fa fa-times-circle'></i><span><strong><small></small></strong></span></a> </span>";                    
                    }
                    else {
                        echo "<span> <a href=?module=unalert&pages=pengumuman&id=$id title='Keluarkan dari Alert' class='btn btn-outline btn-warning btn-xs'.";?>
                        onClick="return confirm('Pengumuman akan dikeluarkan dari halaman utama, Anda yakin?');"
                ...
                echo "<span> <a href=?module=delete&pages=pengumuman&id=$id title='delete' class='btn btn-outline btn-danger btn-xs'.";?>
                    onClick="return confirm('Pengumuman akan dihapus, Anda yakin?');"
