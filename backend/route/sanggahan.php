<?php
$query = "SELECT * FROM website WHERE kode LIKE 'sanggahan'";
...
<aside class="right-side">
    ...
    <h1>
    Tentang Website
    <small>Sanggahan</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Tentang Website</li>
        <li class="active">Sanggahan</li>
    </ol>
    </section>
    <!-- Main content -->
    <section class="content">
    <script src="standar_editor/ckeditor.js"></script>
    <form name="sanggahan" method="post" action="?module=sanggahan">  
    ...
    if (isset($_POST['simpan'])){
        ...
        $query = "UPDATE website SET isi_id='$isi_id',isi_en='$isi_en' WHERE kode LIKE 'sanggahan'";
        $sql = mysql_query($query);
        
        if ($sql){        
                echo "<script>alert ('Konten berhasil diupdate, terima kasih')</script>";
		echo '<script type="text/javascript">window.location="?module=sanggahan"</script>'; 
            }
        }
    ?>
    <br>
