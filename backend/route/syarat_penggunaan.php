<?php
$query = "SELECT * FROM website WHERE kode LIKE 'syarat_penggunaan'";
...
<aside class="right-side">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Syarat Penggunaan</li>
    </ol>
    </section>
    <!-- Main content -->
    <section class="content">
    <script src="standar_editor/ckeditor.js"></script>
    <form name="syarat_penggunaan" method="post" action="?module=syarat_penggunaan">  
    ...
    if (isset($_POST['simpan'])){
        ...
        $query = "UPDATE website SET isi_id='$isi_id',isi_en='$isi_en' WHERE kode LIKE 'syarat_penggunaan'";
        $sql = mysql_query($query);
        
        if ($sql){        
                echo "<script>alert ('Konten berhasil diupdate, terima kasih')</script>";
		echo '<script type="text/javascript">window.location="?module=syarat_penggunaan"</script>'; 
            }
        }
    ?>
    <br>
