<aside class="right-side">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Rekam Penumpang Sarana Pengangkut</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">PPLB, Kiriman dan Pos</li>
            <li class="active">Rekam Penumpang Sarana Pengangkut</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">
        <script src="ckeditor/ckeditor.js"></script>
        <form name="aeo" method="post" action="?module=penumpang_sarkut" enctype="multipart/form-data">  
            ...
            if (isset($_POST['simpan'])) {
                ...
                function newID() {
                    $now = date('Y');
                    $query = "SELECT max(urut) as maxID FROM kiriman where jenis='penumpang_sarkut'";
                    $hasil = mysql_query($query);
                    $data = mysql_fetch_array($hasil);
                    $idMax = $data['maxID'];

                    $querybaru = "SELECT * FROM kiriman where urut='$idMax' and  jenis='penumpang_sarkut'";
                ...
                $query = "INSERT INTO kiriman (judul_id,judul_en,isi_id,isi_en,jenis,urut)"
                        . " VALUES ('$judul_id','$judul_en','$isi_id','$isi_en','penumpang_sarkut','$nourutbaru')";
                $sql = mysql_query($query);

                if ($sql) {
                    echo "<script>alert ('Barang Penumpang berhasil disimpan, terima kasih')</script>";
                    ...
                    while ($r = mysql_fetch_array($sql)) {
                        ...
                        <tr align='center'>
                            ...
                            <td class='odd gradeX'>
                                ...
                                <span> <a href=?module=delete&pages=kiriman&id=<?php echo $id ?> title='delete' onClick="return confirm('FAQ Barang Penumpang dan Sarkut akan dihapus, Anda yakin?');"  class='btn btn-outline btn-danger btn-xs'> <i class='fa fa-trash-o'></i></a> </span>
                            </td>
                        </tr>
                        <?php
                        $no++;
