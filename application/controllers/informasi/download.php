...
class Download extends MY_Controller {
	...
	public function index()
	{
            ...
            if ($p==='true') 
            {
                ...
                {
                    $config["base_url"] = base_url() . "informasi/download.html?p=true&keyword=".$keyword;
                    ...
                    $this->load->view('informasi/download',$data);
                } 
                else 
                {
                    $config["base_url"] = base_url() . "informasi/download.html?p=true";
        ...
        public function baca($slug=NULL) 
        {
            ...
            else 
            {
                ...
                if ($row && $download_lain) 
                {
                    ...
                    $this->load->view('informasi/download_baca',$data);
                }
                else 
                {
                    redirect('error/not_found');
...
/* Location: ./application/controllers/informasi/download.php */