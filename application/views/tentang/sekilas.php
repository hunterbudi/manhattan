        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_sekilas'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    ...
                    <div class="span9">
                        <div class="judul4"><strong><i class="fa fa-bookmark-o"></i> <?php echo $this->lang->line('nav_sekilas'); ?></strong></div>
