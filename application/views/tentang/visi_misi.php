        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_visi_misi'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    ...
                    <div class="span9">
                        <div class="judul4"><strong><i class="fa fa-bullseye"></i> <?php echo $this->lang->line('nav_visi_misi'); ?></strong></div>
