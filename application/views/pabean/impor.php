        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_pabean'); ?> <span class="divider"><i class="fa fa-angle-right"></i></span></li>
                    <li class="active"><?php echo $this->lang->line('nav_impor'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    <div class="span3">
                        <?php $this->load->view('pabean/sidebar'); ?>
                    </div>
                    <div class="span9">
                        <div class="judul4">
                            <strong><i class="fa fa-external-link-square fa-rotate-90"></i> <?php echo $this->lang->line('nav_impor'); ?></strong>
