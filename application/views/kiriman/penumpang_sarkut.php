        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_kiriman_dll'); ?> <span class="divider"><i class="fa fa-angle-right"></i></span></li>
                    <li class="active"><?php echo $this->lang->line('nav_penumpang_sarkut'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    <div class="span3">
                        <?php $this->load->view('kiriman/sidebar'); ?>
                    </div>
                    <div class="span9">
                        <div class="judul4">
                            <strong><i class="fa fa-briefcase"></i> <?php echo $this->lang->line('nav_penumpang_sarkut'); ?></strong>
