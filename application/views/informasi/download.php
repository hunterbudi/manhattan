            ...
            <div class="container">
                ...
                <div class="row-fluid" style="min-height: 300px">
                    <div class="span3">
                        ...
                        <form action="<?php echo site_url('informasi/download'); ?>" method="post">
                            <div class="input-append input-block-level" id="my_append">
                                ...
                                if ($keyword){
                                ?>
                                <span class="add-on"><a href="<?php echo site_url('informasi/download') ?>" class="btn" id="my_search_reset_button">Reset</a></span>
                                <?php
                                }
                                ?>
                    ...
                    <div class="span9">
                        ...
                        ?>
                            ...
                            ?>
                            <div title="<?php echo $this->lang->line('informasi_dowload_detail'); ?>" class="download-title" data-id="<?php echo $row->id ?>">
