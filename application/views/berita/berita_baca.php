        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_berita_baca'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    ...
                    <div class="span9">
                        ...
                        <br>
                        <div class="judul4"><strong><i class="fa fa-newspaper-o"></i> <?php echo $this->lang->line('berita_lain'); ?></strong></div>
                        <table width="100%">
                            <?php 
