        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_kegiatan'); ?> <span class="divider"><i class="fa fa-angle-right"></i></span></li>
                    <li class="active"><?php echo $this->lang->line('nav_kegiatan_baca'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    ...
                    <div class="span9">
                        ...
                        <br>
                        <div class="judul4"><strong><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('kegiatan_lain'); ?></strong></div>
                        <table width="100%">
                            <?php 
                            foreach ($kegiatan_lain as $row) {
