        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_kegiatan'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    <div class="span3">
                        <div class="judul4"><strong><i class="fa fa-search"></i> <?php echo $this->lang->line('kegiatan_search'); ?></strong></div>
                        <form action="<?php echo site_url('berita/kegiatan'); ?>" method="post">
                            <div class="input-append input-block-level" id="my_append">
                                <input name="keyword" class="" type="text" id="keyword" placeholder="<?php echo $this->lang->line('kegiatan_search'); ?>" value="<?php echo $keyword ?>">
                                <?php 
                                if ($keyword){
                                ?>
                                <span class="add-on"><a href="<?php echo site_url('berita/kegiatan') ?>" class="btn" id="my_search_reset_button">Reset</a></span>
                                <?php
                                }
                                ?>
                    ...
                    <div class="span9">
                        <div class="judul4"><strong><i class="fa fa-check-square-o"></i> <?php echo $this->lang->line('nav_kegiatan'); ?></strong></div>
                        <?php 
                        if ($total_rows>0) {
                        ?>
                        <ul class="media-list">
                            ...
                            $slug_url = 'berita/kegiatan/baca/'.$row->slug;
                        ...
                        {
                            echo $this->lang->line('kegiatan_tidak_ada');
                            echo '<strong> ';
                            echo $keyword;
                            echo '.</strong>';
                        }
