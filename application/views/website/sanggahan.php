        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_sanggahan'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    ...
                    <div class="span9">
                        <div class="judul4"><strong><i class="fa fa-shield"></i> <?php echo $this->lang->line('nav_sanggahan'); ?></strong></div>
