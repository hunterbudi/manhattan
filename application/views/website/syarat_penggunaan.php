        ...
        <div style="background-color: white">
            ...
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><?php echo $this->lang->line('nav_syarat_penggunaan'); ?></li>
                </ul>
                <div class="row-fluid" style="min-height: 300px">
                    ...
                    <div class="span9">
                        <div class="judul4"><strong><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('nav_syarat_penggunaan'); ?></strong></div>
